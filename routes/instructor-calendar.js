/**
 * DEPRECATED: was mounted at /api/instructor-calendar; moved to routes/instructor/calendar.js (now /api/instructor/calendar).
 ...
 */
module.exports = require('./instructor/calendar');
