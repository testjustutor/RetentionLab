...
router.post('/videos', requireAuth, (req, res) => ctrl.getVideoRecordings(req).then(r => res.status(r.statusCode || 200).json(r)));
...
router.post('/summaries', requireAuth, (req, res) => ctrl.getSummaries(req).then(r => res.status(r.statusCode || 200).json(r)));
