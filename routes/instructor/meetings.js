/**
 * routes/instructor/meetings.js
 * Instructor-scoped meetings endpoints. All endpoints filter by req.user.email
 * from the auth session.
 * Moved from routes/instructor-meetings.js (was mounted at /api/admin/instructor-meetings);
 * now mounted by routes/instructor/index.js at /meetings (under /api/instructor).
 */
const express = require('express');
const router = express.Router();
const { requireAuth, requireRole } = require('../../middleware/auth');
const ctrl = require('../../controllers/instructor/instructorMeetingsController');
