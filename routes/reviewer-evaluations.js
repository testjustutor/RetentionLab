/**
 * DEPRECATED: was mounted at /api/tutor-evaluation; moved to routes/reviewer/evaluations.js (now /api/reviewer/evaluations).
 ...
 */
module.exports = require('./reviewer/evaluations');
