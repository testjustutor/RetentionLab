...
router.post('/all', requireAuth, (req, res) => ctrl.getAllMeetings(req).then(r => res.status(r.statusCode || 200).json(r)));
router.get('/live', requireAuth, (req, res) => ctrl.getLiveMeetings(req).then(r => res.status(r.statusCode || 200).json(r)));
router.post('/completed', requireAuth, (req, res) => ctrl.getCompletedMeetings(req).then(r => res.status(r.statusCode || 200).json(r)));
