...
const AuthModel = require('../../../models/super_admin/auth/AuthModel');
...
const userController = {
  ...
  async create(req) {
    try {
      ...
      // FIX: 'student' added to match controllers/users/usersController.js
      // (the top-level counterpart) and the now-synced UsersModel check.
      if (data.role_id) {
