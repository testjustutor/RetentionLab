/**
 * models/super_admin/companies/CompaniesModel.js
 * FIX: was a byte-for-byte copy of models/companies/CompaniesModel.js (only
 ...
 * logic to maintain.
 */
module.exports = require('../../companies/CompaniesModel');
