/**
 * models/super_admin/archives/ArchivesModel.js
 * FIX: was a byte-for-byte copy of models/archives/ArchivesModel.js (only
 ...
 * logic to maintain.
 */
module.exports = require('../../archives/ArchivesModel');
