/**
 * models/super_admin/settings/UserSettingsModel.js
 * FIX: was a byte-for-byte copy of models/settings/UserSettingsModel.js
 ...
 * logic to maintain.
 */
module.exports = require('../../settings/UserSettingsModel');
