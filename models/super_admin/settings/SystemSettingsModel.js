/**
 * models/super_admin/settings/SystemSettingsModel.js
 * FIX: was a byte-for-byte copy of models/settings/SystemSettingsModel.js
 ...
 * logic to maintain.
 */
module.exports = require('../../settings/SystemSettingsModel');
