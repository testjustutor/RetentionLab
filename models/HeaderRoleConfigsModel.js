...
class HeaderRoleConfigsModel {
  ...
  static upsert(data) {
    return new Promise((resolve, reject) => {
      const sql = `INSERT INTO header_role_configs (role_id, home_href, home_label, events_href, events_label, archives_href, archives_label, profile_href, profile_label, settings_href, settings_label, is_active, created_by, updated_by, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT(role_id) DO UPDATE SET home_href=excluded.home_href, home_label=excluded.home_label, events_href=excluded.events_href, events_label=excluded.events_label, archives_href=excluded.archives_href, archives_label=excluded.archives_label, profile_href=excluded.profile_href, profile_label=excluded.profile_label, settings_href=excluded.settings_href, settings_label=excluded.settings_label, is_active=excluded.is_active, updated_by=excluded.updated_by, updated_at=CURRENT_TIMESTAMP`;
