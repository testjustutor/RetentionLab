...
class CalendarCredentialsModel {
  ...
  static async create({ provider_id, client_id, client_secret, tenant_id = null, redirect_uris, javascript_origins, extra_config = null, is_active = 1 }) {
    ...
    const result = await runAsync(
      `INSERT INTO calendar_credentials
       (provider_id, client_id, client_secret, tenant_id, redirect_uris, javascript_origins, extra_config, is_active)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`
      , [
        provider_id,
        client_id,
