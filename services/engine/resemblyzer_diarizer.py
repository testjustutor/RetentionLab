...
Fully independent implementation inside the consolidated engine. If Resemblyzer
is not installed, the diarizer returns a single "SPEAKER_00" track covering the
whole file so the pipeline still produces well-formed output.
"""
