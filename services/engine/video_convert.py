"""
services/engine/video_convert.py
...
CLI:
    python -m services.engine.video_convert <video_path> <mp3_path>
...
def main(argv):
    if len(argv) < 3:
        print(json.dumps({"success": False, "error": "usage: python -m services.engine.video_convert <video> <mp3>"}))
        return 1
