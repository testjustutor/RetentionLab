"""
services/python_engine/audit
=============================

AI audit (rubric-driven) pipeline, isolated from the legacy `services/engine`
AI audit service so it can never conflict with it.

Flow (same as the legacy audit, but self-contained here):
