"""
services/assemblyai_engine/main.py

Standalone CLI entry, mirrors services/python_engine/main.py's contract so
runner.js / other outer pages can call it the same way.

Usage:
    python -m services.assemblyai_engine.main <audio_path> [opts_json] [--output out.json]
"""
